...
class Robot
{
    ...
    public:
        Robot(std::string id = "1")
        {
            ...
            this->api_key = "85cf20685df44f3c96ba7280760e4146";
            this->user_id = id;
        }
...
class SpeechRec{
    ...
    public:
        ...
        {
            app_id = "16870064";
            api_key = "ftZnjRGmSvcMYPrIQPIsODpX";
            secret_key = "N4PlMUdeGr8F8EGPHTOccXGIMRDo1KPT";
            ...
            while(!quit)
            {
                if(Record())
                {
                    ...
                    if(sr.ASR(ASR_PATH,message))
                    {
                        ...
                        {
                            std::cout << "[Mr@bogon ]$ " << cmd <<std::endl;
                            Util::Exec(cmd,true);
                            continue;
                        }
                     ...
                     std::cout <<"我# " << message <<std::endl;
                       if(message == "你走吧。")
                       {
                           ...
                           std:: cout << "mr# " << quit_message <<std::endl;
